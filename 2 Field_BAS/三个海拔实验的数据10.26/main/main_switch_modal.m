...
%goal_xy=round([647,2864]*0.1);%新切换起点
%start_xy=round([647,2864]*0.1);%新切换终点
...
%goal_xy=round([392,835]*0.1);%新切换起点
% start_xy=round([392,835]*0.1);%新切换终点
...
%goal_xy=round([1646,522]*0.1);%新切换起点
%start_xy=round([1646,522]*0.1);%新切换终点
